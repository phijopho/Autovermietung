    ...
    <div class="AboutUsContainer">
        ...
        <div class="backgroundImage">
            ...
            <div class="heading">
                ...
                <h2>Herzlich willkommen bei <b style="color: aqua;"><em>SWIFT rentals</em></b>, eurer zuverl&auml;ssigen Adresse f&uuml;r individuelle Mobilit&auml;t!</h2>
            ...
            <div class="why">
                <p class="text"><b style="color: aqua;">Was uns auszeichnet?</b> <br>Neben unserem engagierten Team sind es unsere Werte: <b><em>Vertrauen, Zuverl&auml;ssigkeit und Kundenzufriedenheit</em></b>. Wir legen gro&szlig;en Wert darauf, transparente und faire Preise anzubieten, ohne dabei auf Qualit&auml;t zu verzichten. Jedes Mitglied unseres Teams ist bestrebt, Ihnen den besten Service zu bieten – von der Fahrzeugauswahl bis zur R&uuml;ckgabe.
                    ...
                    Bei <b style="color: aqua;"><em>SWIFT rentals</em></b> geht es nicht nur um Autos, sondern auch um Menschen. Wir freuen uns darauf, Sie pers&Ouml;nlich kennenzulernen und Ihnen dabei zu helfen, Ihre Reise mit einem L&auml;cheln auf dem Gesicht zu beginnen. Vertrauen Sie darauf, dass wir Ihre Mobilit&auml;tsbed&uuml;rfnisse verstehen und Ihnen einen erstklassigen Service bieten. <br></p>
            </div>

            <!--class to postion fourth box-->
            <div class="thank">
                <h2><b style="color: aqua;">Vielen Dank</b>, dass Sie sich f&uuml;r <b style="color: aqua;"><em>SWIFT rentals</em></b> entschieden haben. Gemeinsam machen wir jede Fahrt zu einem unvergesslichen Erlebnis!</h2>
            </div>
        </div>
    </div>
</body>
