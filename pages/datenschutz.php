...
<div class="DatenschutzContainer"> <!--Klasse um Text im Body zu positionieren -->
    ...
    <div class="DatenschutzText">
    a) Automatische Datenverarbeitung: <br>

    <div class="bulletPoint">&#9642; Datum und Uhrzeit des Zugriffs</div>
    <div class="bulletPoint">&#9642; Name und URL der abgerufenen Datei</div>
    <div class="bulletPoint">&#9642; Website, von der aus der Zugriff erfolgt (Referrer-URL)</div>
    <div class="bulletPoint">&#9642; Verwendeter Browser und ggf. Betriebssystem sowie der Name des Access-Providers</div>
    
    <br> <!--Um Absatz hinzuzufügen-->

    b) Zwecke der Verarbeitung: <br>
